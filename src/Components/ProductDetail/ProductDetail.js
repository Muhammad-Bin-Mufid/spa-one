...
const ProductDetail = () => {
    ...
    let productDetailFinder = fakeData.find(pd => pd.key === productKey)
    console.log(productDetailFinder);
    return (
        <div>
            <h2>{productKey} Detail coming sooooooooooooon!</h2>
            <Product showAddToCart={false} product={productDetailFinder}/>
        </div>
    );
};
